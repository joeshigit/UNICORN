...
import { AuthDomainError, signInWithGoogle } from '@/lib/auth'
...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (!loading && user && isOrgUser) router.replace('/fill')
  }, [loading, user, isOrgUser, router])
